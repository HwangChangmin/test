...
public class MemberVO {
	int rno,jstatus;
	String id,name,gender,pass,email,addr,phone_comp,
			phone_number,dy_hobby,intro,jdate,jgrade;
	...
	public String getDy_hobby() {
		return dy_hobby;
	}
	public void setDy_hobby(String dy_hobby) {
		this.dy_hobby = dy_hobby;
	}
