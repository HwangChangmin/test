...
<head>
	...
	$(document).ready(function(){
		...
		jQuery('#ampaginationsm').on('am.pagination.change',function(e){
	           ...
	           $(location).attr('href', "http://localhost:9090/dycgv/admin_notice.do?rpage="+e.page);         
	    });
				...
				<div>
					...
					<table class="notice_list">
						...
						<tr>
							...
							<td><a href="admin_notice_content.do?nid=<%= list.get(i).getNid() %>"><%= list.get(i).getNtitle() %></a></td>
